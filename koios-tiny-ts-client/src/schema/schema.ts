export type paths = {
    ...
    "/era_summaries": {
        ...
        /**
         * Get Era Summaries
         * @description Get some information about each era on the network alongwith it's start epoch
         */
        get: operations["era_summaries"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/tx_by_metalabel": {
         ...
         */
        get: operations["tx_by_metalabel"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/tx_outs_epoch": {
        ...
        /**
         * Transaction outputs by epoch
         * @description Get a list of all transaction outputs for requested epoch
         */
        get: operations["tx_outs_epoch"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/asset_list": {
        ...
        /**
         * Asset List
         * @description Get the list of all native assets (paginated). Use the optional parameters to filter efficiently, bypassing the performance cost of filtering the encoded output. Results are pre-sorted by policy ID and then asset name.
         */
    ...
    "/pool_invalid_delegators": {
        ...
        /**
         * Pool Invalid Delegators
         * @description Return information about delegators for a given pool that are invalid for the specified epoch.
         */
        get: operations["pool_invalid_delegators"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/reference_script_utxos": {
         ...
         */
        post: operations["reference_script_utxos"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export type components = {
    schemas: {
        ...
        tip: {
            ...
            era?: components["schemas"]["era_summaries"][number]["era"];
        ...
        era_summaries: {
             ...
             */
            era?: string;
            protocol_major?: components["schemas"]["epoch_params"][number]["protocol_major"];
            protocol_minor?: components["schemas"]["epoch_params"][number]["protocol_minor"];
            /**
             * @description Protocol name that denotes  collection of features sitting between consensus and ledger layer
             * @example Praos
             */
            ledger_protocol?: string;
            /**
            ...
            first_block_time?: components["schemas"]["epoch_info"][number]["first_block_time"];
            first_block_hash?: components["schemas"]["epoch_params"][number]["block_hash"];
        }[];
        ...
        /** @description Array of pool delegators that are invalid for the specified epoch */
        pool_invalid_delegators: {
            stake_address?: components["schemas"]["account_history"][number]["stake_address"];
            epoch_no?: components["schemas"]["epoch_info"][number]["epoch_no"];
        }[];
        ...
        pool_calidus_keys: {
            ...
            block_time?: components["schemas"]["blocks"][number]["block_time"];
            /**
             * @description Flag to show if the pool has active calidus key as registered
             * @example true
             */
            registered?: boolean;
            /**
             * @description Raw Transaction metadata in hex
             * @example 19029a324512
             */
            bytes?: string;
        }[];
        ...
        address_list: {
            ...
            /**
             * @description Cardano address in hex format
             * @example 60f879af535c02e37bf77fb3b5f51d017229fe47995c37b9aca9e0091c
             */
            address_hex?: string;
            ...
            stake_address_hex?: components["schemas"]["account_list"][number]["stake_address_hex"] | null;
        }[];
        /** @description Array of information for address(es) */
        address_info: {
            address?: components["schemas"]["utxo_infos"][number]["address"];
        ...
        tx_by_metalabel: {
            ...
            epoch_no?: components["schemas"]["blocks"][number]["epoch_no"];
            absolute_slot?: components["schemas"]["blocks"][number]["abs_slot"];
            tx_timestamp?: components["schemas"]["blocks"][number]["block_time"];
        }[];
        ...
        drep_info: {
            ...
            has_script?: boolean;
            /**
             * @description DRep's current registration status
             * @example registered
             * @enum {string}
             */
        ...
        drep_list: {
            ...
            has_script?: components["schemas"]["drep_info"][number]["has_script"];
            drep_status?: components["schemas"]["drep_info"][number]["drep_status"];
        }[];
    ...
    era_summaries: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["era_summaries"];
                };
            };
            400: components["responses"]["BadRequest"];
            401: components["responses"]["Unauthorized"];
    ...
    tx_by_metalabel: {
        parameters: {
            query: {
                 ...
                 * @example 721
                 */
                _label: components["parameters"]["_label"];
                /** @description Block height for specifying time delta */
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["tx_by_metalabel"];
                };
            };
            400: components["responses"]["BadRequest"];
            401: components["responses"]["Unauthorized"];
    ...
    tx_outs_epoch: {
        parameters: {
            query: {
                 ...
                 * @example 320
                 */
                _epoch_no: components["parameters"]["_epoch_no_reqd"];
            };
            header?: never;
            path?: never;
            cookie?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["tx_outs_epoch"];
                };
            };
            400: components["responses"]["BadRequest"];
            401: components["responses"]["Unauthorized"];
    ...
    address_list: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["address_list"];
                };
            };
            400: components["responses"]["BadRequest"];
            401: components["responses"]["Unauthorized"];
    ...
    pool_invalid_delegators: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["pool_invalid_delegators"];
                };
            };
            400: components["responses"]["BadRequest"];
            401: components["responses"]["Unauthorized"];
